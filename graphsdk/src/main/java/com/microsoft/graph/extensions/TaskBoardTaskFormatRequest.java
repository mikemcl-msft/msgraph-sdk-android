...
public class TaskBoardTaskFormatRequest extends BaseTaskBoardTaskFormatRequest implements ITaskBoardTaskFormatRequest {
     ...
     */
    public TaskBoardTaskFormatRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, TaskBoardTaskFormat.class);
    }
}
