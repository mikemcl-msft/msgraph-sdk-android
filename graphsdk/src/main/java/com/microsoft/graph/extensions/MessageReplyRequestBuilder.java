...
public class MessageReplyRequestBuilder extends BaseMessageReplyRequestBuilder implements IMessageReplyRequestBuilder {
     ...
     */
    public MessageReplyRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Message message, final String comment) {
