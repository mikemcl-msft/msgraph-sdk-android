...
public class WorkbookProcessQueryRequestBuilder extends BaseWorkbookProcessQueryRequestBuilder implements IWorkbookProcessQueryRequestBuilder {
     ...
     */
    public WorkbookProcessQueryRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options, final java.io.InputStream input) {
        super(requestUrl, client, options, input);
    }
}
