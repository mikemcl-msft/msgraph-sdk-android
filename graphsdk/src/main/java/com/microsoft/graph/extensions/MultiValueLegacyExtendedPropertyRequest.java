...
public class MultiValueLegacyExtendedPropertyRequest extends BaseMultiValueLegacyExtendedPropertyRequest implements IMultiValueLegacyExtendedPropertyRequest {
     ...
     */
    public MultiValueLegacyExtendedPropertyRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, MultiValueLegacyExtendedProperty.class);
    }
}
