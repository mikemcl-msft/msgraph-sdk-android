...
public class WorkbookCreateSessionRequestBuilder extends BaseWorkbookCreateSessionRequestBuilder implements IWorkbookCreateSessionRequestBuilder {
     ...
     */
    public WorkbookCreateSessionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options, final Boolean persistChanges) {
        super(requestUrl, client, options, persistChanges);
    }
}
