...
public class SectionCopyToSectionGroupRequestBuilder extends BaseSectionCopyToSectionGroupRequestBuilder implements ISectionCopyToSectionGroupRequestBuilder {
     ...
     */
    public SectionCopyToSectionGroupRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options, final String id, final String groupId, final String renameAs) {
