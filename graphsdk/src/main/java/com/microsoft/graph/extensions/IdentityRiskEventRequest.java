...
public class IdentityRiskEventRequest extends BaseIdentityRiskEventRequest implements IIdentityRiskEventRequest {
     ...
     * @param options The options for this request
     */
    public IdentityRiskEventRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, IdentityRiskEvent.class);
    }
}
