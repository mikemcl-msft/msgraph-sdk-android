...
public class UserGetMailTipsCollectionRequestBuilder extends BaseUserGetMailTipsCollectionRequestBuilder implements IUserGetMailTipsCollectionRequestBuilder {
     ...
     */
    public UserGetMailTipsCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final List<String> emailAddresses, final MailTipsType mailTipsOptions) {
