...
public class PageCopyToSectionRequestBuilder extends BasePageCopyToSectionRequestBuilder implements IPageCopyToSectionRequestBuilder {
     ...
     */
    public PageCopyToSectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options, final String id, final String groupId) {
        super(requestUrl, client, options, id, groupId);
    }
}
