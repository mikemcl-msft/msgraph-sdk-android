...
public class BaseOrgContactCollectionRequest extends BaseCollectionRequest<BaseOrgContactCollectionResponse, IOrgContactCollectionPage> implements IBaseOrgContactCollectionRequest {
     ...
     */
    public BaseOrgContactCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseOrgContactCollectionResponse.class, IOrgContactCollectionPage.class);
    }
