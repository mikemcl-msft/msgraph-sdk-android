...
/**
 * The interface for the Base OAuth2Permission Grant With Reference Request.
 */
public interface IBaseOAuth2PermissionGrantWithReferenceRequest extends IHttpRequest {
    ...
    IBaseOAuth2PermissionGrantWithReferenceRequest select(final String value);

    IBaseOAuth2PermissionGrantWithReferenceRequest expand(final String value);
