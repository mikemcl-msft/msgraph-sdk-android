...
public class BaseBaseItemRequestBuilder extends BaseRequestBuilder implements IBaseBaseItemRequestBuilder {
     ...
     */
    public BaseBaseItemRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IBaseItemRequest buildRequest(final List<Option> requestOptions) {
