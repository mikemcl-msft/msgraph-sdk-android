...
public class BaseWorkbookCreateSessionRequest extends BaseRequest implements IBaseWorkbookCreateSessionRequest {
     ...
     */
    public BaseWorkbookCreateSessionRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, SessionInfo.class);
        mBody = new WorkbookCreateSessionBody();
    }

    public void post(final ICallback<SessionInfo> callback) {
        send(HttpMethod.POST, callback, mBody);
    }

    public SessionInfo post() throws ClientException {
