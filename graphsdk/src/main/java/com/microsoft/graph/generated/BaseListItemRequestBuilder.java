...
public class BaseListItemRequestBuilder extends BaseRequestBuilder implements IBaseListItemRequestBuilder {
     ...
     */
    public BaseListItemRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IListItemRequest buildRequest(final List<Option> requestOptions) {
     ...
     */
    public IFieldValueSetRequestBuilder getColumnSet() {
        return new FieldValueSetRequestBuilder(getRequestUrlWithAdditionalSegment("columnSet"), getClient(), null);
    }
