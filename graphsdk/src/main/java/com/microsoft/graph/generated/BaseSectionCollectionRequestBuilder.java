...
public class BaseSectionCollectionRequestBuilder extends BaseRequestBuilder implements IBaseSectionCollectionRequestBuilder {
     ...
     */
    public BaseSectionCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
    ...
    public ISectionCollectionRequest buildRequest(final List<Option> options) {
        return new SectionCollectionRequest(getRequestUrl(), getClient(), options);
    }
