...
public class BaseGroupWithReferenceRequestBuilder extends BaseRequestBuilder implements IBaseGroupWithReferenceRequestBuilder {
     ...
     */
    public BaseGroupWithReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IGroupWithReferenceRequest buildRequest(final List<Option> requestOptions) {
