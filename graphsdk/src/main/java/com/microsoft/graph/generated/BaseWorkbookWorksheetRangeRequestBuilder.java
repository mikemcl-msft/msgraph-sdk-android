...
public class BaseWorkbookWorksheetRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookWorksheetRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @param requestOptions The options for this request
     */
    public BaseWorkbookWorksheetRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String address) {
        super(requestUrl, client, requestOptions);
     ...
     * @return The IWorkbookWorksheetRangeRequest instance
     */
    public IWorkbookWorksheetRangeRequest buildRequest(final List<Option> requestOptions) {
