...
/**
 * The class for the Base Org Contact Request.
 */
public class BaseOrgContactRequest extends BaseRequest implements IBaseOrgContactRequest {
     ...
     */
    public BaseOrgContactRequest(final String requestUrl,
