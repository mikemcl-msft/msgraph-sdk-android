...
/**
 * The interface for the Base Entity With Reference Request.
 */
public interface IBaseEntityWithReferenceRequest extends IHttpRequest {
    ...
    IBaseEntityWithReferenceRequest select(final String value);

    IBaseEntityWithReferenceRequest expand(final String value);
