...
public class BaseSingleValueLegacyExtendedPropertyCollectionRequestBuilder extends BaseRequestBuilder implements IBaseSingleValueLegacyExtendedPropertyCollectionRequestBuilder {
     ...
     */
    public BaseSingleValueLegacyExtendedPropertyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
    ...
    public ISingleValueLegacyExtendedPropertyCollectionRequest buildRequest(final List<Option> options) {
        return new SingleValueLegacyExtendedPropertyCollectionRequest(getRequestUrl(), getClient(), options);
    }
