...
public class BaseExtensionPropertyCollectionRequest extends BaseCollectionRequest<BaseExtensionPropertyCollectionResponse, IExtensionPropertyCollectionPage> implements IBaseExtensionPropertyCollectionRequest {
     ...
     */
    public BaseExtensionPropertyCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseExtensionPropertyCollectionResponse.class, IExtensionPropertyCollectionPage.class);
    }
