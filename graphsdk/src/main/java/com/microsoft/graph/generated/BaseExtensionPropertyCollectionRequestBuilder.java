...
public class BaseExtensionPropertyCollectionRequestBuilder extends BaseRequestBuilder implements IBaseExtensionPropertyCollectionRequestBuilder {
     ...
     */
    public BaseExtensionPropertyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
    ...
    public IExtensionPropertyCollectionRequest buildRequest(final List<Option> options) {
        return new ExtensionPropertyCollectionRequest(getRequestUrl(), getClient(), options);
    }
