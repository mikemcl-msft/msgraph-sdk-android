...
public interface IBaseWorkbookRequestBuilder extends IRequestBuilder {
     ...
     */
    IWorkbookRequest buildRequest(final List<Option> options);

    /**
     * Gets the request builder for ExcelApplication.
     */
    IExcelApplicationRequestBuilder getApplication();
    ...
    IWorkbookProcessQueryRequestBuilder getProcessQuery(final java.io.InputStream input);
