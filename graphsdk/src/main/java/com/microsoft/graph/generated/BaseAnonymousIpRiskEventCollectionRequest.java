...
public class BaseAnonymousIpRiskEventCollectionRequest extends BaseCollectionRequest<BaseAnonymousIpRiskEventCollectionResponse, IAnonymousIpRiskEventCollectionPage> implements IBaseAnonymousIpRiskEventCollectionRequest {
     ...
     */
    public BaseAnonymousIpRiskEventCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseAnonymousIpRiskEventCollectionResponse.class, IAnonymousIpRiskEventCollectionPage.class);
    }
