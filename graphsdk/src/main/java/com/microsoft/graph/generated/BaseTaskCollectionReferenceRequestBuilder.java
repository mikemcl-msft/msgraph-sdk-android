...
public class BaseTaskCollectionReferenceRequestBuilder extends BaseRequestBuilder implements IBaseTaskCollectionReferenceRequestBuilder {
     ...
     */
    public BaseTaskCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
    ...
    public ITaskCollectionReferenceRequest buildRequest(final List<Option> options) {
        return new TaskCollectionReferenceRequest(getRequestUrl(), getClient(), options);
    }
}
