...
/**
 * The class for the Base Mention Request.
 */
public class BaseMentionRequest extends BaseRequest implements IBaseMentionRequest {
     ...
     */
    public BaseMentionRequest(final String requestUrl,
     ...
     */
    public void get(final ICallback<Mention> callback) {
     ...
     * @param callback The callback to be called after success or failure.
     */
    public void patch(final Mention sourceMention, final ICallback<Mention> callback) {
