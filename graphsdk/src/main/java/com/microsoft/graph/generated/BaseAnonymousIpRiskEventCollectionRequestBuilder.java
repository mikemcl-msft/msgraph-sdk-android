...
public class BaseAnonymousIpRiskEventCollectionRequestBuilder extends BaseRequestBuilder implements IBaseAnonymousIpRiskEventCollectionRequestBuilder {
     ...
     */
    public BaseAnonymousIpRiskEventCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IAnonymousIpRiskEventCollectionRequest buildRequest(final List<Option> requestOptions) {
        return new AnonymousIpRiskEventCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }
