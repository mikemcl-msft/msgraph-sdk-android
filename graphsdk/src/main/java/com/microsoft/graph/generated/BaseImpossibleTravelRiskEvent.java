...
/**
 * The class for the Base Impossible Travel Risk Event.
 */
public class BaseImpossibleTravelRiskEvent extends LocatedRiskEvent implements IJsonBackedObject {


    public BaseImpossibleTravelRiskEvent() {
        oDataType = "microsoft.graph.impossibleTravelRiskEvent";
    }
