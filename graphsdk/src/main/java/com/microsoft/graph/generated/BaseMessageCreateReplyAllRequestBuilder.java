...
public class BaseMessageCreateReplyAllRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseMessageCreateReplyAllRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Message message, final String comment) {
