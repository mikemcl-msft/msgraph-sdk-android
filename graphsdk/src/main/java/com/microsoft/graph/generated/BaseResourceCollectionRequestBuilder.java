...
public class BaseResourceCollectionRequestBuilder extends BaseRequestBuilder implements IBaseResourceCollectionRequestBuilder {
     ...
     */
    public BaseResourceCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
    ...
    public IResourceCollectionRequest buildRequest(final List<Option> options) {
        return new ResourceCollectionRequest(getRequestUrl(), getClient(), options);
    }
