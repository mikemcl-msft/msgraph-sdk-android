...
/**
 * The class for the Base Group Collection With References Request.
 */
public class BaseGroupCollectionWithReferencesRequest extends BaseCollectionRequest<BaseGroupCollectionResponse, IGroupCollectionPage> implements IBaseGroupCollectionWithReferencesRequest {
     ...
     */
    public BaseGroupCollectionWithReferencesRequest(final String requestUrl, IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseGroupCollectionResponse.class, IGroupCollectionPage.class);
    }

    public void get(final ICallback<IGroupCollectionWithReferencesPage> callback) {
    ...
    public IGroupCollectionWithReferencesRequest select(final String value) {
        ...
        return (GroupCollectionWithReferencesRequest)this;
    }
    ...
    public IGroupCollectionWithReferencesPage buildFromResponse(final BaseGroupCollectionResponse response) {
