...
public class BaseSingleValueLegacyExtendedPropertyRequestBuilder extends BaseRequestBuilder implements IBaseSingleValueLegacyExtendedPropertyRequestBuilder {
     ...
     */
    public BaseSingleValueLegacyExtendedPropertyRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public ISingleValueLegacyExtendedPropertyRequest buildRequest(final List<Option> options) {
        return new SingleValueLegacyExtendedPropertyRequest(getRequestUrl(), getClient(), options);
    }
