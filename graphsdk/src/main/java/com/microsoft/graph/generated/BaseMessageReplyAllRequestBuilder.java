...
public class BaseMessageReplyAllRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseMessageReplyAllRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Message message, final String comment) {
