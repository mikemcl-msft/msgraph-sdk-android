...
/**
 * The class for the Base Automatic Replies Mail Tips.
 */
public class BaseAutomaticRepliesMailTips implements IJsonBackedObject {

    @SerializedName("@odata.type")
    @Expose(serialize = false)
    public String oDataType;

    public BaseAutomaticRepliesMailTips() {
