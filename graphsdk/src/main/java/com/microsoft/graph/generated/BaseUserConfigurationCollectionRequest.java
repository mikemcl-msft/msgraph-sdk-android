...
public class BaseUserConfigurationCollectionRequest extends BaseCollectionRequest<BaseUserConfigurationCollectionResponse, IUserConfigurationCollectionPage> implements IBaseUserConfigurationCollectionRequest {
     ...
     */
    public BaseUserConfigurationCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseUserConfigurationCollectionResponse.class, IUserConfigurationCollectionPage.class);
    }
