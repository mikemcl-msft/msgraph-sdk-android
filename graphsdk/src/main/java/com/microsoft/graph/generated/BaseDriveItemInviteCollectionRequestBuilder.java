 ...
 */
public class BaseDriveItemInviteCollectionRequestBuilder extends BasePostMethodRequestBuilder implements IBaseDriveItemInviteCollectionRequestBuilder {
     ...
     */
    public BaseDriveItemInviteCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options, final Boolean requireSignIn, final List<String> roles, final Boolean sendInvitation, final String message, final List<DriveRecipient> recipients) {
    ...
    public IDriveItemInviteCollectionRequest buildRequest(final List<Option> options) {
