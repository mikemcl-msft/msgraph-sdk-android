...
/**
 * The class for the Base Plan Collection Response.
 */
public class BasePlanCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Plan within this collection page
     */
