...
/**
 * The interface for the Base User Invalidate All Refresh Tokens Request Builder.
 */
public interface IBaseUserInvalidateAllRefreshTokensRequestBuilder extends IRequestBuilder {
     ...
     * @return The IUserInvalidateAllRefreshTokensRequest instance
     */
    IUserInvalidateAllRefreshTokensRequest buildRequest(final List<Option> requestOptions);
}
