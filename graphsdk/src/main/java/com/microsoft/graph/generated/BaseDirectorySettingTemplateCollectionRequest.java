...
public class BaseDirectorySettingTemplateCollectionRequest extends BaseCollectionRequest<BaseDirectorySettingTemplateCollectionResponse, IDirectorySettingTemplateCollectionPage> implements IBaseDirectorySettingTemplateCollectionRequest {
     ...
     */
    public BaseDirectorySettingTemplateCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, BaseDirectorySettingTemplateCollectionResponse.class, IDirectorySettingTemplateCollectionPage.class);
    }
