...
public class BaseOfficeGraphInsightsRequestBuilder extends BaseRequestBuilder implements IBaseOfficeGraphInsightsRequestBuilder {
     ...
     */
    public BaseOfficeGraphInsightsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IOfficeGraphInsightsRequest buildRequest(final List<Option> requestOptions) {
