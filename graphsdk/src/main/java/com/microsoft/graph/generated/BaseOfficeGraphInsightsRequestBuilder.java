...
public class BaseOfficeGraphInsightsRequestBuilder extends BaseRequestBuilder implements IBaseOfficeGraphInsightsRequestBuilder {
     ...
     */
    public BaseOfficeGraphInsightsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public IOfficeGraphInsightsRequest buildRequest(final List<Option> options) {
        return new OfficeGraphInsightsRequest(getRequestUrl(), getClient(), options);
    }

    public ITrendingCollectionRequestBuilder getTrending() {
        return new TrendingCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("trending"), getClient(), null);
    }

    public ITrendingRequestBuilder getTrending(final String id) {
