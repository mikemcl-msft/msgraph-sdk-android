...
public class BaseGroupRenewRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseGroupRenewRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IGroupRenewRequest instance
     */
    public IGroupRenewRequest buildRequest(final List<Option> requestOptions) {
