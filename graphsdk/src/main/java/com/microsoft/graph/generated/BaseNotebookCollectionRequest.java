...
public class BaseNotebookCollectionRequest extends BaseCollectionRequest<BaseNotebookCollectionResponse, INotebookCollectionPage> implements IBaseNotebookCollectionRequest {
     ...
     */
    public BaseNotebookCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseNotebookCollectionResponse.class, INotebookCollectionPage.class);
    }
