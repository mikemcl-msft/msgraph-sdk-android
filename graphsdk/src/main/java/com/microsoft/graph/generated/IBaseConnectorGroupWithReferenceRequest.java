...
/**
 * The interface for the Base Connector Group With Reference Request.
 */
public interface IBaseConnectorGroupWithReferenceRequest extends IHttpRequest {
    ...
    IBaseConnectorGroupWithReferenceRequest select(final String value);

    IBaseConnectorGroupWithReferenceRequest expand(final String value);
