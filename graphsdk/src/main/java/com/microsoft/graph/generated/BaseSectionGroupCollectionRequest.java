...
public class BaseSectionGroupCollectionRequest extends BaseCollectionRequest<BaseSectionGroupCollectionResponse, ISectionGroupCollectionPage> implements IBaseSectionGroupCollectionRequest {
     ...
     */
    public BaseSectionGroupCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseSectionGroupCollectionResponse.class, ISectionGroupCollectionPage.class);
    }
