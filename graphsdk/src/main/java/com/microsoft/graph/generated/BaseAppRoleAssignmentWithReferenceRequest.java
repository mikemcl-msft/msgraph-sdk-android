...
/**
 * The class for the Base App Role Assignment With Reference Request.
 */
public class BaseAppRoleAssignmentWithReferenceRequest extends BaseRequest implements IBaseAppRoleAssignmentWithReferenceRequest {
     ...
     */
    public BaseAppRoleAssignmentWithReferenceRequest(String requestUrl, IBaseClient client, List<Option> options) {
        super(requestUrl, client, options, AppRoleAssignment.class);
    }

    public void post(final AppRoleAssignment newAppRoleAssignment, final IJsonBackedObject payload, final ICallback<AppRoleAssignment> callback) {
