...
public class BaseMessageForwardRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseMessageForwardRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Message message, final String comment, final List<Recipient> toRecipients) {
