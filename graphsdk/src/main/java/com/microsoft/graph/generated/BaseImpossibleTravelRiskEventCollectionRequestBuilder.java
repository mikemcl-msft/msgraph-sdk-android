...
public class BaseImpossibleTravelRiskEventCollectionRequestBuilder extends BaseRequestBuilder implements IBaseImpossibleTravelRiskEventCollectionRequestBuilder {
     ...
     */
    public BaseImpossibleTravelRiskEventCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IImpossibleTravelRiskEventCollectionRequest buildRequest(final List<Option> requestOptions) {
        return new ImpossibleTravelRiskEventCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }
