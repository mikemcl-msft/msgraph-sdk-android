...
public class BasePlanDetailsRequestBuilder extends BaseRequestBuilder implements IBasePlanDetailsRequestBuilder {
     ...
     */
    public BasePlanDetailsRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public IPlanDetailsRequest buildRequest(final List<Option> options) {
        return new PlanDetailsRequest(getRequestUrl(), getClient(), options);
    }
