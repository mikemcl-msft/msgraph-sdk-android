...
public class BaseNotebookCopyNotebookRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseNotebookCopyNotebookRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final String groupId, final String renameAs, final String notebookFolder) {
     ...
     * @return The INotebookCopyNotebookRequest instance
     */
    public INotebookCopyNotebookRequest buildRequest(final List<Option> requestOptions) {
