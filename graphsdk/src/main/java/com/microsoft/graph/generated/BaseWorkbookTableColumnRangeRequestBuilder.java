...
public class BaseWorkbookTableColumnRangeRequestBuilder extends BaseFunctionRequestBuilder {
     ...
     */
    public BaseWorkbookTableColumnRangeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IWorkbookTableColumnRangeRequest instance
     */
    public IWorkbookTableColumnRangeRequest buildRequest(final List<Option> requestOptions) {
