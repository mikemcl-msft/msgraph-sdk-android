...
/**
 * The interface for the Base Scoped Role Membership Request.
 */
public interface IBaseScopedRoleMembershipRequest extends IHttpRequest {
     ...
     */
    IBaseScopedRoleMembershipRequest select(final String value);
     ...
     * @return The updated request
     */
    IBaseScopedRoleMembershipRequest expand(final String value);
