...
public class BaseMultiValueLegacyExtendedPropertyCollectionRequest extends BaseCollectionRequest<BaseMultiValueLegacyExtendedPropertyCollectionResponse, IMultiValueLegacyExtendedPropertyCollectionPage> implements IBaseMultiValueLegacyExtendedPropertyCollectionRequest {
     ...
     */
    public BaseMultiValueLegacyExtendedPropertyCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseMultiValueLegacyExtendedPropertyCollectionResponse.class, IMultiValueLegacyExtendedPropertyCollectionPage.class);
    }
