...
/**
 * The class for the Base On Premises Publishing.
 */
public class BaseOnPremisesPublishing implements IJsonBackedObject {

    @SerializedName("@odata.type")
    @Expose(serialize = false)
    public String oDataType;

    public BaseOnPremisesPublishing() {
     ...
     */
    @SerializedName("customDomainCertificate")
    @Expose
