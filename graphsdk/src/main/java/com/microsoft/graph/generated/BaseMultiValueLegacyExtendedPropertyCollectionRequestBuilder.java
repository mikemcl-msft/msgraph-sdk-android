...
public class BaseMultiValueLegacyExtendedPropertyCollectionRequestBuilder extends BaseRequestBuilder implements IBaseMultiValueLegacyExtendedPropertyCollectionRequestBuilder {
     ...
     */
    public BaseMultiValueLegacyExtendedPropertyCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
    ...
    public IMultiValueLegacyExtendedPropertyCollectionRequest buildRequest(final List<Option> options) {
        return new MultiValueLegacyExtendedPropertyCollectionRequest(getRequestUrl(), getClient(), options);
    }
