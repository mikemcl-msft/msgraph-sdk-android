...
public class BaseUserFindMeetingTimesRequest extends BaseRequest implements IBaseUserFindMeetingTimesRequest {
     ...
     */
    public BaseUserFindMeetingTimesRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
        super(requestUrl, client, requestOptions, MeetingTimeCandidatesResult.class);
        mBody = new UserFindMeetingTimesBody();
    }

    public void post(final ICallback<MeetingTimeCandidatesResult> callback) {
        send(HttpMethod.POST, callback, mBody);
    }

    public MeetingTimeCandidatesResult post() throws ClientException {
