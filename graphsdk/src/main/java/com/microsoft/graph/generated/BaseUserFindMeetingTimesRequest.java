...
public class BaseUserFindMeetingTimesRequest extends BaseRequest implements IBaseUserFindMeetingTimesRequest {
     ...
     */
    public BaseUserFindMeetingTimesRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, MeetingTimeCandidatesResult.class);
