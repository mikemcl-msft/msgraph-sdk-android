...
/**
 * The class for the Base Section Collection Response.
 */
public class BaseSectionCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Section within this collection page
     */
