...
/**
 * The interface for the Base Privileged Role Settings With Reference Request.
 */
public interface IBasePrivilegedRoleSettingsWithReferenceRequest extends IHttpRequest {
    ...
    IBasePrivilegedRoleSettingsWithReferenceRequest select(final String value);

    IBasePrivilegedRoleSettingsWithReferenceRequest expand(final String value);
