...
public class BaseMessageCreateForwardRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseMessageCreateForwardRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions, final Message message, final String comment, final List<Recipient> toRecipients) {
