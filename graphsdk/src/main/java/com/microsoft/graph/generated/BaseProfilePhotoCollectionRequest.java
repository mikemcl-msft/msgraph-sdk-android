...
public class BaseProfilePhotoCollectionRequest extends BaseCollectionRequest<BaseProfilePhotoCollectionResponse, IProfilePhotoCollectionPage> implements IBaseProfilePhotoCollectionRequest {
     ...
     */
    public BaseProfilePhotoCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseProfilePhotoCollectionResponse.class, IProfilePhotoCollectionPage.class);
    }
