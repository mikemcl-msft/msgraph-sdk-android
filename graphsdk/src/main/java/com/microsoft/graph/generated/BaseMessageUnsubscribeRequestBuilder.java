 ...
 */
public class BaseMessageUnsubscribeRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BaseMessageUnsubscribeRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IMessageUnsubscribeRequest instance
     */
    public IMessageUnsubscribeRequest buildRequest(final List<Option> requestOptions) {
