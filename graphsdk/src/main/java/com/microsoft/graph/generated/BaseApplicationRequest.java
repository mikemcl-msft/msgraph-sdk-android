...
/**
 * The class for the Base Application Request.
 */
public class BaseApplicationRequest extends BaseRequest implements IBaseApplicationRequest {
     ...
     */
    public BaseApplicationRequest(final String requestUrl,
