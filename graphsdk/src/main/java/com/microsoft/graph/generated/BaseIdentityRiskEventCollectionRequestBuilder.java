...
public class BaseIdentityRiskEventCollectionRequestBuilder extends BaseRequestBuilder implements IBaseIdentityRiskEventCollectionRequestBuilder {
     ...
     */
    public BaseIdentityRiskEventCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IIdentityRiskEventCollectionRequest buildRequest(final List<Option> requestOptions) {
        return new IdentityRiskEventCollectionRequest(getRequestUrl(), getClient(), requestOptions);
    }
