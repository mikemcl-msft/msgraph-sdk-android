...
/**
 * The class for the Base Scoped Role Membership.
 */
public class BaseScopedRoleMembership extends Entity implements IJsonBackedObject {


    public BaseScopedRoleMembership() {
