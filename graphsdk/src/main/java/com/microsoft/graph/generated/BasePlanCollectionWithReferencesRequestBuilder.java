...
public class BasePlanCollectionWithReferencesRequestBuilder extends BaseRequestBuilder implements IBasePlanCollectionWithReferencesRequestBuilder {
     ...
     */
    public BasePlanCollectionWithReferencesRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
    ...
    public IPlanCollectionWithReferencesRequest buildRequest(final List<Option> options) {
        return new PlanCollectionWithReferencesRequest(getRequestUrl(), getClient(), options);
    }
