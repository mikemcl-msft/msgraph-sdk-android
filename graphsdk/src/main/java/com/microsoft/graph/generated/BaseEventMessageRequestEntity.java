...
/**
 * The class for the Base Event Message Request Entity.
 */
public class BaseEventMessageRequestEntity extends EventMessage implements IJsonBackedObject {


    public BaseEventMessageRequestEntity() {
        oDataType = "microsoft.graph.eventMessageRequestEntity";
    }
