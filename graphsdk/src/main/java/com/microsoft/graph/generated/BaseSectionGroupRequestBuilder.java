...
public class BaseSectionGroupRequestBuilder extends BaseRequestBuilder implements IBaseSectionGroupRequestBuilder {
     ...
     */
    public BaseSectionGroupRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public ISectionGroupRequest buildRequest(final List<Option> requestOptions) {
