...
public class BasePageStreamRequestBuilder extends BaseRequestBuilder implements IBasePageStreamRequestBuilder {
     ...
     */
    public BasePageStreamRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     */
    public IPageStreamRequest buildRequest(final List<Option> requestOptions) {
        return new PageStreamRequest(getRequestUrl(), getClient(), requestOptions);
    }
