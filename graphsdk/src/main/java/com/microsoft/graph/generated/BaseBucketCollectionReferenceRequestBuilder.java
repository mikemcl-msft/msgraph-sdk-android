...
public class BaseBucketCollectionReferenceRequestBuilder extends BaseRequestBuilder implements IBaseBucketCollectionReferenceRequestBuilder {
     ...
     */
    public BaseBucketCollectionReferenceRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IBucketCollectionReferenceRequest buildRequest(final List<Option> requestOptions) {
        return new BucketCollectionReferenceRequest(getRequestUrl(), getClient(), requestOptions);
    }
}
