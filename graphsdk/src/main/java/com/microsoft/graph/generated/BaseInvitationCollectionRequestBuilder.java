...
public class BaseInvitationCollectionRequestBuilder extends BaseRequestBuilder implements IBaseInvitationCollectionRequestBuilder {
     ...
     */
    public BaseInvitationCollectionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
    ...
    public IInvitationCollectionRequest buildRequest(final List<Option> requestOptions) {
