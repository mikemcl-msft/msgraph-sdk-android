 ...
 */
public class BaseWorkbookCreateSessionRequestBuilder extends BasePostMethodRequestBuilder {
     ...
     */
    public BaseWorkbookCreateSessionRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options, final Boolean persistChanges) {
     ...
     * @return The IWorkbookCreateSessionRequest instance
     */
    public IWorkbookCreateSessionRequest buildRequest(final List<Option> options) {
