...
public class BaseServicePrincipalCollectionRequest extends BaseCollectionRequest<BaseServicePrincipalCollectionResponse, IServicePrincipalCollectionPage> implements IBaseServicePrincipalCollectionRequest {
     ...
     */
    public BaseServicePrincipalCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseServicePrincipalCollectionResponse.class, IServicePrincipalCollectionPage.class);
    }
