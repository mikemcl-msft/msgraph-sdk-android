...
public class BasePersonCollectionRequest extends BaseCollectionRequest<BasePersonCollectionResponse, IPersonCollectionPage> implements IBasePersonCollectionRequest {
     ...
     */
    public BasePersonCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BasePersonCollectionResponse.class, IPersonCollectionPage.class);
    }
