...
/**
 * The class for the Base Privileged Role Assignment Make Eligible Request Builder.
 */
public class BasePrivilegedRoleAssignmentMakeEligibleRequestBuilder extends BaseActionRequestBuilder {
     ...
     */
    public BasePrivilegedRoleAssignmentMakeEligibleRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
     ...
     * @return The IPrivilegedRoleAssignmentMakeEligibleRequest instance
     */
    public IPrivilegedRoleAssignmentMakeEligibleRequest buildRequest(final List<Option> requestOptions) {
