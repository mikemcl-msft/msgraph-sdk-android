...
public class BaseTrendingCollectionRequest extends BaseCollectionRequest<BaseTrendingCollectionResponse, ITrendingCollectionPage> implements IBaseTrendingCollectionRequest {
     ...
     */
    public BaseTrendingCollectionRequest(final String requestUrl, IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseTrendingCollectionResponse.class, ITrendingCollectionPage.class);
    }
