...
public class BaseDriveItemInviteCollectionRequest extends BaseCollectionRequest<BaseDriveItemInviteCollectionResponse, IDriveItemInviteCollectionPage> implements IBaseDriveItemInviteCollectionRequest {
     ...
     */
    public BaseDriveItemInviteCollectionRequest(final String requestUrl, final IBaseClient client, final List<Option> options) {
        super(requestUrl, client, options, BaseDriveItemInviteCollectionResponse.class, IDriveItemInviteCollectionPage.class);
