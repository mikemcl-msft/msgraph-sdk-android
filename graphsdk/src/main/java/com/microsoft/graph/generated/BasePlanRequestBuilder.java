...
public class BasePlanRequestBuilder extends BaseRequestBuilder implements IBasePlanRequestBuilder {
     ...
     */
    public BasePlanRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public IPlanRequest buildRequest(final List<Option> options) {
        return new PlanRequest(getRequestUrl(), getClient(), options);
    }
