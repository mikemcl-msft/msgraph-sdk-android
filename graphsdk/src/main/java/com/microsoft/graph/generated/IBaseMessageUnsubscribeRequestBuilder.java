...
/**
 * The interface for the Base Message Unsubscribe Request Builder.
 */
public interface IBaseMessageUnsubscribeRequestBuilder extends IRequestBuilder {
     ...
     * @return The IMessageUnsubscribeRequest instance
     */
    IMessageUnsubscribeRequest buildRequest(final List<Option> requestOptions);
}
