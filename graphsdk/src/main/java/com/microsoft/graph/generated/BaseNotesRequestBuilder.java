...
public class BaseNotesRequestBuilder extends BaseRequestBuilder implements IBaseNotesRequestBuilder {
     ...
     */
    public BaseNotesRequestBuilder(final String requestUrl, final IBaseClient client, final List<Option> options) {
     ...
     */
    public INotesRequest buildRequest(final List<Option> options) {
        return new NotesRequest(getRequestUrl(), getClient(), options);
    }
