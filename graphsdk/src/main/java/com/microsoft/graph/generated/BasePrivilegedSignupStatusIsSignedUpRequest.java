...
/**
 * The class for the Base Privileged Signup Status Is Signed Up Request.
 */
public class BasePrivilegedSignupStatusIsSignedUpRequest extends BaseRequest implements IBasePrivilegedSignupStatusIsSignedUpRequest {
     ...
     */
    public BasePrivilegedSignupStatusIsSignedUpRequest(final String requestUrl, final IBaseClient client, final List<Option> requestOptions) {
