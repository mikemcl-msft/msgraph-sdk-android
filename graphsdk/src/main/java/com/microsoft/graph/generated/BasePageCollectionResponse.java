...
/**
 * The class for the Base Page Collection Response.
 */
public class BasePageCollectionResponse implements IJsonBackedObject {

    /**
     * The list of Page within this collection page
     */
